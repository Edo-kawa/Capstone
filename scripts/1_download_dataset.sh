#!/bin/bash
DATASET_DIR=${1:-"./datasets/audioset"}   # Default argument.
...
python3 utils/dataset.py download_wavs \
    --csv_path=$DATASET_DIR"/metadata/unbalanced_train_segments.csv" \
    --audios_dir=$DATASET_DIR"/audios/unbalanced_train_segments"
